if (UNIX AND CMAKE_SYSTEM_NAME MATCHES Linux)
   ...
   if (NOT RPMBUILD_FOUND)
      ...
      set(CPACK_RPM_RUNTIME_FILE_NAME        ${CPACK_RPM_PACKAGE_NAME}-${PROJECT_VERSION}-${VERSION_LABEL}-${RHEL}.${OS_NAME}.onbings.rpm)
      set(CPACK_RPM_DEVEL_FILE_NAME          ${CPACK_RPM_PACKAGE_NAME}-devel-${PROJECT_VERSION}-${VERSION_LABEL}.rpm)
      set(CPACK_RPM_DEBUG_FILE_NAME          ${CPACK_RPM_PACKAGE_NAME}-debug-${PROJECT_VERSION}-${VERSION_LABEL}-${RHEL}.${OS_NAME}.onbings.rpm)
