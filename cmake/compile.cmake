...
if ((CMAKE_BUILD_TYPE STREQUAL "Debug") OR (CMAKE_BUILD_TYPE STREQUAL "RelWithDebInfo"))
	if(MSVC)
		...
		string(FIND "${CMAKE_CXX_FLAGS}" "-ggdb" FLG_POS)
		if(FLG_POS EQUAL -1)
...
set(THRIFT_IDL_FILE_IN_DIR ${CMAKE_CURRENT_SOURCE_DIR}/idl)
set(THRIFT_IDL_FILE_OUT_DIR ${CMAKE_CURRENT_BINARY_DIR}/thrift)
set(GRPC_IDL_FILE_IN_DIR ${CMAKE_CURRENT_SOURCE_DIR}/idl)
set(GRPC_IDL_FILE_OUT_DIR ${CMAKE_CURRENT_BINARY_DIR}/grpc)
set(GRPC_FBS_IDL_FILE_IN_DIR ${CMAKE_CURRENT_SOURCE_DIR}/idl)
set(GRPC_FBS_IDL_FILE_OUT_DIR ${CMAKE_CURRENT_BINARY_DIR}/fbs)
