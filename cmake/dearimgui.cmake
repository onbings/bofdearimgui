#string(FIND "${CMAKE_CXX_FLAGS}" "-DHELLOIMGUI_USE_SDL2=ON -DHELLOIMGUI_HAS_OPENGL3=ON" FLG_POS)
#if(FLG_POS EQUAL -1)
...
#endif()
string(FIND "${CMAKE_CXX_FLAGS}" "-DHELLOIMGUI_USE_GLFW3=ON -DHELLOIMGUI_HAS_OPENGL3=ON" FLG_POS)
if(FLG_POS EQUAL -1)
	set(CMAKE_C_FLAGS   "${CMAKE_C_FLAGS}   -DHELLOIMGUI_USE_GLFW3=ON -DHELLOIMGUI_HAS_OPENGL3=ON")
	set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHELLOIMGUI_USE_GLFW3=ON -DHELLOIMGUI_HAS_OPENGL3=ON")
endif()
